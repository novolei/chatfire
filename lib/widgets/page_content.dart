...
class Page_content extends StatefulWidget {
  Page_content({Key key}) : super(key: key);

  @override
  _Page_contentState createState() => _Page_contentState();
}
...
class TextAndButton extends StatelessWidget {
  const TextAndButton({Key key, this.content, this.buttonText, this.onPressed}) : super(key: key);
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          RaisedButton(
            ...
            child: Text(buttonText, style: Theme.of(context).textTheme.headline.copyWith(color: Colors.white)),
            onPressed: onPressed,
          ),
        ],
      ),
