            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  child: Hero(
                      tag: "image-${widget.character.name}", child: Image.asset(widget.character.imagePath, height: screenHeight * 0.45)),
                ),
                Padding(
                  ...
                  child: Hero(
                      ...
                      child: Material(
                          color: Colors.transparent, child: Container(child: Text(widget.character.name, style: AppTheme.heading)))),
                ),
                Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: Text('_______', style: AppTheme.subheading.copyWith(color: Colors.black))),
                      ],
                    ),
                  ),
                  SingleChildScrollView(
